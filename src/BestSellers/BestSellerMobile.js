...
const BestSellerMobile = () => {
    ...
    useEffect(() => {
        axios.get("https://e-mqem.onrender.com/BestSellers/BestSellerMobile")
            ...
            <div id='best-sellers'>
                ...
                <div className='bestseller-products-data-container'>
                    <div className='bestseller-products-data'>
                        {
                            data.slice(0, visible).filter((item, index) => { return item.id >= 106 && item.id <= 120 }).map((element, index) => (
